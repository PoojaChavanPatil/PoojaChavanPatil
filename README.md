...
**ML & Statistics:** Scikit-learn, TensorFlow, SMOTE, Regression, Classification, Ensemble Methods, Time Series Analysis, Monte Carlo Simulation
...
| [Asteroid Risk Assessment](https://github.com/PoojaChavanPatil/Asteroid-Risk-Assessment-ML) | Classification of potentially hazardous asteroids using KNN, Random Forest, and Gradient Boosting with SMOTE | Python, Scikit-learn, Seaborn |
...
| [Marketplace Forecast Simulator](https://github.com/PoojaChavanPatil/marketplace-forecast-simulator) | Predicting product sales on Wish e-commerce platform using ensemble ML methods | Python, XGBoost, Scikit-learn |
| [Python Data Science Journey](https://github.com/PoojaChavanPatil/python-data-science-journey) | Structured learning in Python for Data Science with hands-on labs and statistical testing | Python, Pandas, Matplotlib |
| [SQL Practice (Coursera)](https://github.com/PoojaChavanPatil/coursera-sql) | SQL queries and exercises from Coursera coursework | SQL |
